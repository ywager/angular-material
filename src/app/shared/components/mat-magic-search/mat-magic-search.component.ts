...
@Component({
  selector: 'app-mat-magic-search',
  templateUrl: './mat-magic-search.component.html',
  styleUrls: ['./mat-magic-search.component.scss']
})
export class MatMagicSearchComponent implements OnInit, OnChanges, DoCheck {
